...
export default function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-transparent">
        ...
        <div className="relative z-10 container mx-auto px-4 sm:px-6">
          <div className="max-w-6xl mx-auto">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
              ...
              <div className="text-left space-y-6 sm:space-y-8">
                ...
                <Button size="lg" asChild className="text-base sm:text-lg px-6 sm:px-8 py-4 sm:py-6 rounded-xl w-full sm:w-auto">
                  <Link href="/sign-in">
                    ...
                    Get Started 
                    <div className="ml-2 sm:ml-3 w-5 h-5 sm:w-6 sm:h-6 bg-foreground/10 rounded-md flex items-center justify-center">
              ...
              <div className="relative h-[500px] sm:h-[600px] w-full max-w-sm mx-auto lg:max-w-md">
                {/* Top Blur Gradient */}
      ...
      {/* Features Section */}
      <section id="features" className="relative py-16 sm:py-20 flex items-center justify-center overflow-hidden">
        {/* Background with animated gradient */}
        <div className="absolute inset-0">
